	...
	$(document).ready(function() {
		...
		$('#contact-form').submit(function(e) {
			...
			if (( c_name== '' || c_email == '' || c_message == '') || (!isValidEmailAddress(c_email) )) {
				...
				responseMessage.html('<i class="fa fa-bell-o"></i> Hataları dÜzeltİp tekrar deneyİn.');
			}
				...
				$.ajax({
					...
					beforeSend: function(result) {
						...
						$('#contact-form button').append('<i class="fa fa-cog fa-spin"></i> Gönderİlİyor...');
					},
					success: function(result) {
						if(result.sendstatus == 1) {
							...
							$('#contact-form button').empty();
							$('#contact-form button').append('<i class="fa fa-retweet"></i> Tekrar deneyİn.');
